...
class MyPasswordChangeForm(PasswordChangeForm):
    old_password = forms.CharField(label=('old Password'), strip=False,
                                   widget=forms.PasswordInput(attrs={'autocomplate':
    ...
    new_password2 = forms.CharField(label=('Conform New Password'), strip=False, widget=forms.PasswordInput
    (attrs={'autocomplate': 'new-password', 'class': 'form-control'}))


class MyPasswordResetForm(PasswordResetForm):
    email = forms.EmailField(label=('Email'), widget=forms.EmailInput(attrs={'autocomplate': 'email', 'class':
